  ...
  return (
    <>
        ...
        <div className="container">
          <div className="nav-inner">
            ...
            <div className="nav-cta">
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="btn btn-gold" style={{ padding: "12px 26px", fontSize: "13px" }}>
                Book Consultation
              </a>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        ...
        <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="btn btn-gold" onClick={() => setMenuOpen(false)} style={{ marginTop: 16 }}>
          Book Consultation
        </a>
      </div>
    </>
        ...
        <div className="pricing-grid">
          {plans.map((p, i) => (
            <div className={`pricing-card reveal reveal-delay-${i + 1} ${p.featured ? "featured" : ""}`} key={p.plan}>
              ...
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className={`btn ${p.featured ? "btn-gold" : "btn-outline"}`} style={{ width: "100%", justifyContent: "center" }}>
                Get Started
              </a>
            </div>
          ))}
        ...
        <div className="footer-top">
          ...
          <div>
            ...
            <ul className="footer-links">
              {["Meta Ads Management", "Google Ads Management", "Lead Generation", "Funnel Optimization", "Performance Consulting"].map((s) => (
                <li key={s}><a href={whatsappLink} target="_blank" rel="noopener noreferrer">{s}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div style={{ marginTop: 28 }}>
              <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="btn btn-gold" style={{ fontSize: "12px", padding: "12px 24px" }}>Book Consultation</a>
            </div>
          </div>
        </div>
...
export default function App() {
  const whatsappLink = "https://wa.me/919999692435";
  useReveal();
  ...
  return (
    <>
      ...
      <div className="sticky-cta">
        <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="btn btn-gold" style={{ width: "100%", justifyContent: "center" }}>
